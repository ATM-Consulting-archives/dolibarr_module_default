...
<div class="tabsAction">
	[onshow;block=begin;when [user.rights.mymodule.write;noerr]=1]
		...
		[onshow;block=begin;when [object.status]=[MyModule.STATUS_DRAFT]]
		...
		[onshow;block=begin;when [object.status]=[MyModule.STATUS_VALIDATED]]
		...
		<!-- '-+' est l'équivalent d'un signe '<' (TBS oblige) -->
		[onshow;block=begin;when [object.status]-+[MyModule.STATUS_REFUSED]]
